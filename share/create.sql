...
-- Create model Domain
--
CREATE TABLE `dashboard_domain` (`UUID` uuid NOT NULL PRIMARY KEY, `id` integer NOT NULL, `name` varchar(100) NOT NULL, `status` varchar(10) NOT NULL, `max_ram` integer NOT NULL, `current_ram` integer NOT NULL, `vcpus` integer NOT NULL, `vnc_port` integer NULL, `proxy_port` integer NULL, `ip` varchar(15) NOT NULL, `mac-address` varchar(18) NOT NULL, `node_id` bigint NULL);
